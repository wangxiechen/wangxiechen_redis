/**  
 *
 * @Title: RedisHashJDK.java
 * @Description: TODO
 * @author: wangxiechen
 * @date: 2019年8月12日 上午9:08:03
 * @version: V1.0  
 */
...
public class RedisHashJDK {
	@Resource
	private RedisTemplate<String, Serializable> redis;
	
	@Test
	public void redis_hashjdk() {
		//new 一个list对象
		...
		System.out.println("hash_jdk需要的时间是:"+(stop-start));//12627
	}
}
